...
public class View extends JFrame {
	...
	public View() {
		...
		funcTest.setFont(new Font("굴림", Font.PLAIN, 30));
		ampm.setFont(new Font("굴림", Font.PLAIN, 30));
		sec.setFont(new Font("굴림", Font.PLAIN, 30));
		sec10.setFont(new Font("굴림", Font.PLAIN, 30));
		min.setFont(new Font("굴림", Font.PLAIN, 30));
		min10.setFont(new Font("굴림", Font.PLAIN, 30));
		hour.setFont(new Font("굴림", Font.PLAIN, 30));
		hour10.setFont(new Font("굴림", Font.PLAIN, 30));
		datelb.setFont(new Font("굴림", Font.PLAIN, 30));
		daylb.setFont(new Font("굴림", Font.PLAIN, 30));
		monthlb.setFont(new Font("굴림", Font.PLAIN, 30));
		...
		buzzerlb.setFont(new Font("굴림", Font.PLAIN, 30));
